...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-
  ...
  INTEGER, parameter :: Node = 2, Nxy = 2, Lrwork = Nxy * ( 3 * Nxy + 13 ) / 2
  INTEGER            :: NN, itrj, ipt, Lwa, ic05nbf
  REAL               :: xy(1:Node), Fxy(1:Nxy), xya(1:Node), tnow, told, rwork(1:Lrwork), tol
...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-
  ...
  NN = Nxy ; tol = odetol * ten ; Lwa = Lrwork ; xy(1:NN) = zero ; ic05nbf = 1
  
  ;            ; write(ounit,'("pcplot  : " 10x " : calling C05NBF ;")') 
  
  call C05NBF( faxis, NN, xy(1:NN), Fxy(1:NN), tol, rwork(1:Lwa), Lwa, ic05nbf )
  
  select case( ic05nbf )
  case( 0 )    ; write(ounit,'("pcplot  : " 10x " : called  C05NBF ; success ;")') ; xyaxis(1:Node) = xy(1:Node)
  case default ; write(ounit,'("pcplot  : " 10x " : called  C05NBF ; error   ;")') ; xyaxis(1:Node) = zero
  end select
...
subroutine faxis( Nxy, xyi, Fxy, iflag )
  ...
  INTEGER            :: Nxy, iflag
  REAL               :: xyi(1:Nxy), Fxy(1:Nxy), xye(1:Nxy)
  
  xye(1:Nxy) = xyi(1:Nxy)

  call pmap( Node, xye(1:Node) )

  Fxy(1:Nxy) = xye(1:Node) - xyi(1:Node) ! fixed point = magnetic axis;

  write(ounit,'("faxis   : " 10x " : ("f13.9","f13.9" ) --> ("f13.9","f13.9" ) : F = ("es13.5","es13.5" ) ;")') xyi(1:Nxy), xye(1:Nxy), Fxy(1:Nxy)

  return

end subroutine faxis
