...
#ifdef oldcg
SUBROUTINE congrad
  use famus_globals, only: dp, sqrtmachprec, myid, ounit, Ncoils, Ndof, t1E, iout, CG_maxiter, CG_xtol, xdof, &
...
SUBROUTINE wolfe( x0, p, alpha, iflag )
  ...
  use famus_globals, only: dp, zero, sqrtmachprec, ounit, myid, Ndof, CG_wolfe_c1, CG_wolfe_c2
...
REAL FUNCTION zoom( x0, p, alo, ahi )
  ...
  use famus_globals, only : dp, zero, ounit, myid, Ndof, CG_wolfe_c1, CG_wolfe_c2
...
SUBROUTINE getdf(lxdof, f, g)
  use famus_globals, only: dp, myid, ounit, ierr, Ndof, chi, t1E, MPI_COMM_FAMUS
  implicit none
  include "mpif.h"
...
SUBROUTINE myvalue(f, x, n)
  use famus_globals, only: dp, myid, ounit, ierr, chi, MPI_COMM_FAMUS
  implicit none
  include "mpif.h"
...
SUBROUTINE mygrad(g, x, n)
  use famus_globals, only: dp, myid, ounit, ierr, t1E, MPI_COMM_FAMUS
  implicit none
  include "mpif.h"
