...
SUBROUTINE twodft(func, hs, hc, im, in, mn)
  ...
  !-------------------------------------------------------------------------------!
  use focus_globals, only: dp, zero, half, two, pi2, myid, ounit, Nteta, Nzeta, carg, sarg, MPI_COMM_FAMUS
  implicit none
  include "mpif.h"
  !-------------------------------------------------------------------------------
...
SUBROUTINE saveBmn
  ...
  !----------------------------------------------------------------------------------------
  use focus_globals, only: dp, zero, ierr, astat, myid, machprec, weight_Bharm, &
