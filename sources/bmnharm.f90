...
!!$  !----------------------------------------------------------------------------------------
!!$  use famus_globals, only: zero, half, myid, Ndof, Nteta, Nzeta, surf, &
...
SUBROUTINE readBmn
  ...
  !----------------------------------------------------------------------------------------
  use famus_globals, only: dp, zero, half, pi2, myid, ounit, runit, ext, IsQuiet, Nteta, Nzeta, Nfp, &
...
SUBROUTINE twodft(func, hs, hc, im, in, mn)
  ...
  !-------------------------------------------------------------------------------!
  use famus_globals, only: dp, zero, half, two, pi2, myid, ounit, Nteta, Nzeta, carg, sarg, MPI_COMM_FAMUS
  implicit none
  include "mpif.h"
  !-------------------------------------------------------------------------------
...
SUBROUTINE saveBmn
  ...
  !----------------------------------------------------------------------------------------
  use famus_globals, only: dp, zero, ierr, astat, myid, machprec, weight_Bharm, &
