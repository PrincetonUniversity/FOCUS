...
!latex \item All the shared variables are defined in \link{focus_globals};
...
PROGRAM focus
  ...
  use focus_globals, only: dp, ncpu, myid, ounit, ierr, astat, eunit, case_surface, case_coils, case_optimize, &
