...
subroutine fieldline_tracing(x,y,z,imax,n2,H)
  ...
  do j=1,imax
     ...
     if(j<8)then
        ...
        call get_bfield(s,x+dt*4/27*k1x,y+dt*4/27*k1y,z+dt*4/27*k1z)
        Bx=s(1) ; By=s(2) ; Bz=s(3) ; B=s(4)
        k2x=Bx/B ; k2y=By/B ; k2z=Bz/B

        call get_bfield(s,x+dt/18*(k1x+3*k2x),y+dt/18*(k1y+3*k2y),z+dt/18*(k1z+3*k2z))
        Bx=s(1) ; By=s(2) ; Bz=s(3) ; B=s(4)
        k3x=Bx/B ; k3y=By/B ; k3z=Bz/B

        call get_bfield(s,x+dt/12*(k1x+3*k3x),y+dt/12*(k1y+3*k3y),z+dt/12*(k1z+3*k3z))
        Bx=s(1) ; By=s(2) ; Bz=s(3) ; B=s(4)
        k4x=Bx/B ; k4y=By/B ; k4z=Bz/B

        call get_bfield(s,x+dt/8*(k1x+3*k4x),y+dt/8*(k1y+3*k4y),z+dt/8*(k1z+3*k4z))
        Bx=s(1) ; By=s(2) ; Bz=s(3) ; B=s(4)
        k5x=Bx/B ; k5y=By/B ; k5z=Bz/B

        call get_bfield(s,x+dt/54*(13*k1x-27*k3x+42*k4x+8*k5x),y+dt/54*(13*k1y-27*k3y+&
             42*k4y+8*k5y),z+dt/54*(13*k1z-27*k3z+42*k4z+8*k5z))
        Bx=s(1) ; By=s(2) ; Bz=s(3) ; B=s(4)
        k6x=Bx/B ; k6y=By/B ; k6z=Bz/B

        call get_bfield(s,x+dt/4320*(389*k1x-54*k3x+966*k4x-824*k5x+243*k6x),y+dt/4320*(389*k1y-&
             54*k3y+966*k4y-824*k5y+243*k6y),z+dt/4320*(389*k1z-54*k3z+966*k4z-824*k5z+243*k6z))
        Bx=s(1) ; By=s(2) ; Bz=s(3) ; B=s(4)
        k7x=Bx/B ; k7y=By/B ; k7z=Bz/B

        call get_bfield(s,x+dt/20*(-234*k1x+81*k3x-1164*k4x+656*k5x-122*k6x+800*k7x),y+dt/20*(-234*k1y+81*k3y-&
             1164*k4y+656*k5y-122*k6y+800*k7y),z+dt/20*(-234*k1z+81*k3z-1164*k4z+656*k5z-122*k6z+800*k7z))
        Bx=s(1) ; By=s(2) ; Bz=s(3) ; B=s(4)
        k8x=Bx/B ; k8y=By/B ; k8z=Bz/B

        call get_bfield(s,x+dt/288*(-127*k1x+18*k3x-678*k4x+456*k5x-9*k6x+576*k7x+4*k8x),y+&
        ...
        call get_bfield(s,x+dt/820*(1481*k1x-81*k3x+7104*k4x-3376*k5x+&
