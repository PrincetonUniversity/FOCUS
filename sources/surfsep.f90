...
!------------------------------------------------------------------------------------------------------  
  use famus_globals, only: dp, zero, half, pi2, machprec, ncpu, myid, ounit, &
...
!------------------------------------------------------------------------------------------------------  
  use famus_globals, only: dp, zero, coil, myid, ounit, Ncoils, surf, psurf, cssep_factor, MPI_COMM_FAMUS
  implicit none
  include "mpif.h"
...
!------------------------------------------------------------------------------------------------------  
  use famus_globals, only: dp, zero, coil, myid, ounit, Ncoils, surf, psurf, cssep_factor, DoF, MPI_COMM_FAMUS
  implicit none
  include "mpif.h"
