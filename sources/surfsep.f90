...
!------------------------------------------------------------------------------------------------------  
  use focus_globals, only: dp, zero, coil, myid, ounit, Ncoils, surf, psurf, cssep_factor, MPI_COMM_FAMUS
...
!------------------------------------------------------------------------------------------------------  
  use focus_globals, only: dp, zero, coil, myid, ounit, Ncoils, surf, psurf, cssep_factor, DoF, MPI_COMM_FAMUS
  implicit none
  include "mpif.h"
