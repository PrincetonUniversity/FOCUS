...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
  ...
  REAL                 :: teta, zeta, alpha, dd, ds(1:3), ax(1:3), at(1:3), az(1:3), xx(1:3), xt(1:3), xz(1:3), xo(1:3), lo, lknotsurf !for knotatron;

!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!

   INTEGER, parameter  :: Ndof = 2, Ldf = Ndof, LRR = Ndof*(Ndof+1)/2
   INTEGER             :: irevcm, mode, ic05pdf
   REAL                :: phi, rx, rt, rz, ox, ot, oz
   REAL                :: xtol, factor, TZ(1:Ndof), ff(1:Ndof), df(1:Ldf,1:Ndof), diag(1:Ndof), RR(1:LRR), QTf(1:Ndof), rwk(1:Ndof,1:4)
...
!discretize the knot surface data; 2017/03/28; czhu;
  ...
  SALLOCATE( surf(1)%rx, (1:Nteta*Nzeta), zero ) ! points on surface equally spaced in \theta and \phi; 18 Apr 17;
  SALLOCATE( surf(1)%ry, (1:Nteta*Nzeta), zero ) ! points on surface equally spaced in \theta and \phi; 18 Apr 17;
...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
  ...
  if( Mpol.gt.0 ) then
   ...
   if( myid.eq.0 ) then
    ...
    xo(1:3) = zero ; lo = zero ; alpha = zero
    
    do kk = 0, Nzeta-1 ; zeta = kk * (pi2/bNfp) / Nzeta
     lknotsurf = zero ; call knotxx( lknotsurf, alpha, zeta, ax(1:3), at(1:3), az(1:3), xx(1:3), xt(1:3), xz(1:3) )
    ...
    write(ounit,'("rdknot  : " 10x " : (xo,yo,zo) =("f13.7","f13.7","f13.7" ) ; lo ="f12.7" ;")') xo(1:3), lo
    
!  TZ(2) = zero + ten ! note offset in \zeta; 18 Apr 17;
    
    do kk = 0, Nzeta-1 ; phi  = kk * (pi2/bNfp) / Nzeta
     
     TZ(2) = phi + ten
     
!   TZ(1) = zero + ten ! note offset in \teta; 18 Apr 17;
     
     do jj = 0, Nteta-1 ; teta = jj *  pi2       / Nteta ; jk = 1 + jj + kk*Nteta
      ...
      do
       ...
       call C05PDF( irevcm, &
                    Ndof, TZ(1:Ndof), ff(1:Ndof), df(1:Ldf,1:Ndof), &
                    Ldf, xtol, diag(1:Ndof), mode, factor, RR(1:LRR), LRR, QTf(1:Ndof), rwk(1:Ndof,1:4), ic05pdf )
       
       alpha = TZ(1) - ten ; zeta = TZ(2) - ten
       
       call knotxx( knotsurf, alpha, zeta, ax(1:3), at(1:3), az(1:3), xx(1:3), xt(1:3), xz(1:3) )
       ...
       case( 0 ) ; if( ic05pdf.ne.0 ) write(ounit,2000) phi, teta, irevcm, ic05pdf, xx(1:3)
        ;        ;!write(ounit,'("rdknot  : " 10x " : ")')
        ;        ; exit
       case( 1 ) ;!write(ounit,'("rdknot  : " 10x " : alpha,zeta="2es13.5" ; teta,phi="2es13.5" ; ff="2es13.5" ;")') alpha, zeta, teta, phi, ff(1:Ndof)
       case( 2 ) ;!ff(1  ) =   xx(1)           * sin(phi ) -   xx(2)           * cos(phi )
        ;        ; ff(1  ) = ( xx(1) - xo(1) ) * sin(phi ) - ( xx(2) - xo(2) ) * cos(phi )
        ;        ;!ff(2  ) = ( rx    - ox )    * sin(teta) - ( xx(3) - ax(3) ) * cos(teta)
        ;        ; ff(2  ) =   alpha - teta
       case( 3 ) ;!df(1,1) =   xt(1)           * sin(phi ) -   xt(2)           * cos(phi )
        ;        ;!df(1,2) =   xz(1)           * sin(phi ) -   xz(2)           * cos(phi )
        ;        ; df(1,1) =   xt(1)           * sin(phi ) -   xt(2)           * cos(phi )
        ;        ; df(1,2) =   xz(1)           * sin(phi ) -   xz(2)           * cos(phi )
...
2000  format("rdknot  : " 10x " : phi ="es23.15" ; teta="es23.15" ; irevcm="i3" ; ic05pdf="i3" ; xx="3es23.15" ;")
    ...
    ijreal(1:Ntz) = sqrt( surf(1)%rx(1:Ntz) * surf(1)%rx(1:Ntz) + surf(1)%ry(1:Ntz) * surf(1)%ry(1:Ntz) )
    ijimag(1:Ntz) =       surf(1)%rz(1:Ntz)
    
#ifdef CHECKFFT
    ijimag(1:Ntz) = zero
    do kk = 0, Nzeta-1 ; phi  = kk * (pi2/bNfp) / Nzeta
     do jj = 0, Nteta-1 ; teta = jj *  pi2       / Nteta ; jk = 1 + jj + kk*Nteta
      ijimag(jk) = cos( 1 * teta )
     enddo
    enddo
#endif
...
#ifdef CHECKFFT
    do ii = 1, mn
     if( abs(efmn(ii))+abs(ofmn(ii)).gt.small ) write(ounit,'(???)') im(ii), in(ii), efmn(ii), ofnm(ii)
    enddo
    FATAL(rdknot, .true., checking FFT )
#endif
